...
extern uint32 Sky2Actorsky2Tiles[];
extern uint16 Sky2Actorsky2Map[];

//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
// SPRITES
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

CharSetROMSpec Sky2Sprite1CharsetSpec =
{
...
TextureROMSpec Sky2Sprite1TextureSpec =
{
	// Pointer to the char spec that the texture uses
	(CharSetSpec*)&Sky2Sprite1CharsetSpec,
...
ComponentSpec* const Sky2ComponentSpecs[] = 
{
	(ComponentSpec*)&Sky2Sprite1SpriteSpec,
	NULL
};

ActorROMSpec Sky2ActorSpec =
{
	// Class allocator
	__TYPE(Actor),

	// Component specs
	(ComponentSpec**)Sky2ComponentSpecs,
